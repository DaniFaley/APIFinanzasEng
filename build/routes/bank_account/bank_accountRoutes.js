...
router.get('/:id_bank_account', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const bank_account = yield bank_accountServices.findBank_Account(Number(req.params.id_bank_account));
    res.send(bank_account);
}));
// Insertar
